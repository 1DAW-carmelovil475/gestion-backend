  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f4;padding:32px 0;">
    <tr><td align="center">
      <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e0e0e0;">
        ...
        <tr>
          <td style="padding:32px;">
            <p style="margin:0 0 6px;color:#333333;font-size:15px;">Hola, <strong>${gestor.nombre || gestor.email}</strong></p>
            <p style="margin:0 0 24px;color:#555555;font-size:14px;line-height:1.6;">
              <strong>${clienteNombre}</strong> de <strong>${empresa}</strong> ha creado una nueva incidencia:
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e0e0;margin-bottom:24px;">
              <tr>
                ...
                <td width="50%" style="padding:12px 16px;border-bottom:1px solid #e0e0e0;vertical-align:top;">
                  <p style="margin:0 0 3px;color:#888888;font-size:11px;text-transform:uppercase;">Cliente</p>
                  <p style="margin:0;color:#222222;font-size:14px;">${clienteNombre}</p>
                </td>
              </tr>
              <tr>
                <td width="50%" style="padding:12px 16px;border-right:1px solid #e0e0e0;vertical-align:top;">
                  <p style="margin:0 0 3px;color:#888888;font-size:11px;text-transform:uppercase;">Estado</p>
                  <p style="margin:0;color:#222222;font-size:14px;">Pendiente</p>
                </td>
                <td width="50%" style="padding:12px 16px;vertical-align:top;">
                  <p style="margin:0 0 3px;color:#888888;font-size:11px;text-transform:uppercase;">Fecha</p>
                  <p style="margin:0;color:#222222;font-size:14px;">${new Date(ticket.created_at).toLocaleDateString('es-ES', { day: '2-digit', month: 'long', year: 'numeric' })}</p>
    ...
    await emailTransporter.sendMail({
        from:    process.env.EMAIL_FROM || process.env.EMAIL_USER,
        to:      gestor.email,
        subject: `Nueva incidencia de ${clienteNombre} (${empresa}): ${ticket.asunto}`,
        html,
    });
}
      ...
      <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e0e0e0;">
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
              <tr>
                <td style="background:#f0fff4;border-left:3px solid #16a34a;padding:14px 16px;">
                  <p style="margin:0 0 3px;color:#666666;font-size:11px;text-transform:uppercase;letter-spacing:0.5px;">Asunto</p>
                  <p style="margin:0;color:#111111;font-size:16px;font-weight:bold;">${ticket.asunto}</p>
                </td>
              </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e0e0;margin-bottom:24px;">
              <tr>
                ...
                <td width="50%" style="padding:12px 16px;vertical-align:top;">
                  <p style="margin:0 0 3px;color:#888888;font-size:11px;text-transform:uppercase;">Estado</p>
                  <p style="margin:0;color:#16a34a;font-size:14px;font-weight:bold;">Completado</p>
                </td>
              </tr>
            </table>
            <p style="margin:0 0 20px;color:#555555;font-size:14px;line-height:1.6;">
              Si tienes alguna duda o el problema persiste, puedes abrir una nueva incidencia desde tu portal.
            </p>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="padding:8px 0;">
                  <a href="${ticketUrl}" style="display:inline-block;background:#16a34a;color:#ffffff;text-decoration:none;padding:13px 36px;font-size:14px;font-weight:bold;">
                    Ver mis incidencias
                  </a>
                </td>
              </tr>
...
module.exports = { getPerfilesConEmail, enviarEmailAsignacion, enviarEmailIncidenciaGestores, enviarEmailCompletado };